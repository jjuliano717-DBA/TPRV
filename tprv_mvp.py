...
# --- CONFIG & STYLING ---
st.set_page_config(page_title="Align Sure: Governance Core V15", layout="wide")
st.markdown("""<style>
...
st.title("🛡️ Align Sure: Enterprise Governance Core")
            ...
            with st.chat_message("assistant"), st.status("TPRV Validating Identity...", expanded=True) as status:
                ...
                if api_key and OPENAI_AVAILABLE:
                    try:
                        ...
                        system_prompt = f"""
                        You are an Enterprise AI Assistant for the TPRV Align Sure platform.
...
with tab8:
    ...
    st.write("Consultant interface for mapping legacy system fields to the Align Sure platform. Complete vendor mappings and click Validate to establish the data baseline.")
    ...
    with col_adp:
        ...
        st.selectbox("Map ADP Employee Status to Align Sure:", ["Employment_Active_Flag", "HR_Kill_Switch", "ADP_Status_Code"], key="map_adp_status")
    ...
    with col_paycom:
        ...
        st.selectbox("Map Paycom OSHA Field to Align Sure Metric:", ["TRIR", "DART", "EEO-1", "WC Rating Code"], key="map_paycom_osha")
    ...
    with col_biddle:
        ...
        st.selectbox("Map Biddle RTW Assessment to Align Sure:", ["RTW_Functional_Capacity", "Modified_Duty_Eligible", "Transitional_Work_Plan"], key="map_biddle_rtw")
